...
```
.
├── code/flink-job                # flink实验代码
├── code/storm-job                # storm实验代码
├── image                   # 实验相关截图
└── README.md               # 项目核心文档
```
...
实验将在自生成的流式数据集上进行，通过与 Storm 和 Flink 的实际运行表现对比，揭示两者在 At-Least-Once 语义下的优势与不足。
...
| JDK 版本       | 主节点：OpenJDK 21.0.8，从节点：OpenJDK 17.0.7 |
| Flink版本      | Flink 2.1.1                            |
...
![](./image/image-20260101141050042.png)

![](./image/image-20260101141104645.png)
...
![](./image/image-20260101143807108.png)

![](./image/image-20260101143814295.png)

##### 步骤 6：停止实验并获取最终数据

待生产者发送完毕，手动停止生产者，并等待统计脚本输出最终结果。

![](./image/image-20260101144607268.png)
...
![](./image/image-20260101225841012.png)
...
![](./image/image-20260101230217985.png)

![](./image/image-20260101230227291.png)
...
![](./image/image-20260101230710877.png)
